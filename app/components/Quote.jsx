...
export const Quote = ({ color, translations }) => {
  ...
  return (
    <blockquote className="quote row">
      <div className={cs("quote__box row", `bg--${color}`)}>
        <svg className="quote__icon fill--light" viewBox="0 0 349.078 349.078">
          <title>quotation-right-mark</title>
      ...
      <p className="quote__text" suppressHydrationWarning>{content}</p>
    </blockquote>
  )
}

Quote.propTypes = { __component: PropTypes.string }
